...
public class CrearListadoActivity extends AppCompatActivity {
    ...
    private Context listado;
    private ConstraintLayout constraintLayoutMainActivity;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_crear_listado);

        listado = this;
        constraintLayoutMainActivity = findViewById(R.id.constraintLayoutListado);
        ...
        //crear spinner
        Spinner spinner = (Spinner) findViewById(R.id.spinnerListado);
        ...
        btnGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int WriteExternalStoragePermission = ContextCompat.checkSelfPermission(listado, Manifest.permission.WRITE_EXTERNAL_STORAGE);
                ...
                if (WriteExternalStoragePermission != PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
                        ActivityCompat.requestPermissions(CrearListadoActivity.this, new String[] {Manifest.permission.WRITE_EXTERNAL_STORAGE}, CODE_WRITE_EXTERNAL_STORAGE_PERMISSION);
